...
from util import run_commands_threadpool, format_to_decimal
...
def combine_flair():
    main_dir='/lustre/home/cxue/project/GMTiP-RNA/20260131/output/LRS/03_quantification'
...
def gene_expr():
    lrs_dir='/lustre/home/cxue/project/GMTiP-RNA/20260131/output/LRS'
    quant_dir=f'{lrs_dir}/03_quantification/flair_quant'
    flair_combined_out_dir=f'{quant_dir}/combined'
    gtf_prefix={'GTOP':f'{lrs_dir}/isoform_discovery/merged/enhanced_gtf/GTOP_novel-GENCODE_v47'}
